...
import { faInstagram, faFacebookF, faTwitter, faTelegramPlane } from '@fortawesome/free-brands-svg-icons'
function Footer() {
  return (
      <div className='Footer'>
          ...
          <div className="col">
            <div className="socials">
              ...
              <b>Barcha huquqlar himoyalangan. <a href='https://softcity.uz'>SOFTCITY</a>  </b>
            </div>
          </div>
